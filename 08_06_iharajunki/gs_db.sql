...
--
-- Host: localhost
-- Generation Time: 2018 年 10 月 04 日 23:17
-- サーバのバージョン： 5.6.21
-- PHP Version: 5.6.3
...
(1, '井原純輝', '四街道', 'ihara@test.jp', 'Sherlock', 'Holmes'),
(2, 'ホームズ', 'ベーカー街221B', 'Holmes@test.jp', '', ''),
(3, 'シャーロックホームズ', 'ベーカー街221B', 'holmes@bs.jp', 'HOLMES', '221B');
...
(1, 'ihara', 'test@test.jp', '暑い', '2018-09-22 09:41:12', 40),
